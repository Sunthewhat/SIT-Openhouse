      ...
      >
        ...
        <div className='mt-3 grid grid-cols-4 lg:grid-cols-12 gap-y-5 lg:gap-5 w-full'>
          <div className='md:w-[120px] w-full col-span-2 relative flex flex-col'>
            ...
            {errors.title && (
              <span className='absolute -bottom-5 text-red-500 text-sm'>{errors.title}</span>
            )}
          </div>
          <div className='col-span-5 relative flex flex-col'>
            ...
            />
            {errors.firstName && (
              <span className='absolute -bottom-5 text-red-500 text-sm'>{errors.firstName}</span>
            )}
          </div>
          <div className='col-span-5 flex flex-col relative'>
            ...
            />
            {errors.lastName && (
              <span className='absolute -bottom-5 text-red-500 text-sm'>{errors.lastName}</span>
            )}
          </div>
          <div className='col-span-4 flex flex-col relative'>
            ...
            />
            {errors.citizenID && (
              <span className='absolute -bottom-5 text-red-500 text-sm'>{errors.citizenID}</span>
            )}
          </div>
          <div className='col-span-4 flex flex-col relative'>
            <label className='block text-left font-inter text-[16px] font-medium text-[#637381] mb-1'>
            ...
            />
            {errors.email && (
              <span className='absolute -bottom-5 text-red-500 text-sm'>{errors.email}</span>
            )}
          </div>
          <div className='col-span-4 flex flex-col relative'>
            <label className='block text-left font-inter text-[16px] font-medium text-[#637381] mb-1'>
            ...
            />
            {errors.telephone && (
              <span className='absolute -bottom-5 text-red-500 text-sm'>{errors.telephone}</span>
            )}
          </div>
          <div className='col-span-4 flex flex-col relative'>
            <label className='block text-left font-inter text-[16px] font-medium text-[#637381] mb-1'>
            ...
            {errors.currentClass && (
              <span className='absolute -bottom-5 text-red-500 text-sm'>{errors.currentClass}</span>
            )}
          </div>
          <div className='col-span-4 flex flex-col relative'>
            <label className='block text-left font-inter text-[16px] font-medium text-[#637381] mb-1'>
            ...
            />
            {errors.studyPlan && (
              <span className='absolute -bottom-5 text-red-500 text-sm'>{errors.studyPlan}</span>
            )}
          </div>
          <div className='col-span-4'>
            ...
            {schoolSearchError && <p className='text-red-500 absolute'>{schoolSearchError}</p>}
          </div>
        </div>
  ...
  return (
    <Modal isOpen={isOpen} setIsOpen={onClose}>
      <div
        ...
        onClick={(e) => e.stopPropagation()}
      >
        <p className='text-[#1C3FB7] font-bold text-xl text-center'>ยืนยันการลงทะเบียนหรือไม่</p>
        <div className='text-[#637381] text-sm text-center my-8 px-7'>
          ...
          <br />
          ระบบจะส่งอีเมลยืนยันการลงทะเบียนให้ท่านผ่านทางอีเมล โปรดยืนยันการลงทะเบียนภายใน 30
          นาทีนับจากที่อีเมลถูกส่ง <br /> หากท่านเคยลงทะเบียนไปแล้ว
          ระบบจะยกเลิกการลงทะเบียนครั้งก่อนของท่าน และจะแทนที่ด้วยข้อมูลการจองครั้งใหม่ทั้งหมด
        </div>
    ...
    <Modal isOpen={isOpen} setIsOpen={onClose}>
      ...
      >
        ...
        <p className='text-[#637381] text-sm mt-6 text-center'>
          ระบบได้ส่งอีเมลยืนยันการลงทะเบียนของท่านผ่านทางอีเมลแล้ว กรุณายืนยันการลงทะเบียนภายใน 30
          นาทีหลังจากที่อีเมลนี้ถูกส่งให้
        </p>
