		...
		<Modal isOpen={isOpen} setIsOpen={onClose}>
			...
			>
				...
				<div className='text-[#637381] text-sm text-center my-8 px-7'>
					...
					<br />
					ระบบจะส่งอีเมลยืนยันการลงทะเบียนให้ท่านผ่านทางอีเมล โปรดยืนยันการลงทะเบียนภายใน
					30 นาทีนับจากที่อีเมลถูกส่ง <br /> หากท่านเคยลงทะเบียนไปแล้ว
					ระบบจะยกเลิกการลงทะเบียนครั้งก่อนของท่าน
		...
		<Modal isOpen={isOpen} setIsOpen={onClose}>
			...
			>
				...
				<p className='text-[#637381] text-sm mt-6 text-center'>
					...
					กรุณายืนยันการลงทะเบียนภายใน 30 นาทีหลังจากที่อีเมลนี้ถูกส่งให้
				</p>
